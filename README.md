[script opensource by tsuo.txt](https://github.com/user-attachments/files/18138496/script.opensource.by.tsuo.txt)[Uploif game.PlaceId == 2753915549 then
    World1 = true
...
OrionLib:MakeNotification({
    ...
    Image = "rbxassetid://10590477450",
    Time = 5
})ading script opensource by tsuo.txt…]()
